...
var Config = function(adapter, api) { 
    ...
    this.getPaymentTags = function() {
        return new linnCore.PaymentTagResponse([
            new linnCore.PaymentTag("manual payment", "Manual Payment"),
            new linnCore.PaymentTag("paypal", "PayPal"),
            new linnCore.PaymentTag("sagepay", "Sage Pay")
        ]);
    }
}
